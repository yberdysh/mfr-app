...
function WhatIsMFR() {
  ...
  return (
    <div className="wimfr-page">
        ...
        content={
          <div>
            <p>
              ...
              applies sustained pressure to the body in order to release fascial
              restrictions. Your fascia is the connective tissue web throughout
              your body touching every muscle, bone, and organ. Through the
              pizoelectric effect, we can tap into the ground substance and
              collagenous barrier of this 3D matrix, and relieve the 2,000 lbs
              of crushing pressure on pain-sensitive structures.
            </p>
            <p>
              MFR is meant to be experienced. You will not get a good
              understanding of how MFR feels through google searching or reading
              about it – it may just lead you, gentle reader, into more
              confusion and pull you away from trying it out for yourself.
            </p>
          </div>
        }
        buttons={[
      ...
      <Conditions />
      <FaqSection />
      <div className="wimfr-page__review-section">
